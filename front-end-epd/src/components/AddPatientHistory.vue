        ...
        <div class="container">
            <div class="box">
                ...
                <div class="inputBox-textarea">
                    <textarea class="inputBox-field-textarea" type="text" required="required"></textarea>
...
<script>
export default {
    emits: ["changeAddHistoryComponent"],
    methods: {
        closeAddHistory() {
...
<style scoped>@import '../styles/components/addpatienthistory.css';</style>