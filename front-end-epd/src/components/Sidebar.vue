            ...
            <ul id="buttons">
                ...
                <li>
                    <a href="#" v-on:click="makeActive(2), DropdownPatients()" v-bind:class="{ active: isActive == 2 }">
                        ...
                        <span>Patients</span> <span class="dropdown-icon"><svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <ul id="patients">
                        <li>
                            <a href="#" v-on:click="makeActive(3), compToRender = 'AddPatient'"
                        ...
                        <li>
                            <a href="#" v-on:click="makeActive(4), compToRender = 'ViewPatients'"
                        ...
                        <li>
                            <a href="#" v-on:click="makeActive(5), compToRender = 'ManagePatients'"
                ...
                <li>
                    <a href="#" v-on:click="makeActive(6), DropdownEmployees()" v-bind:class="{ active: isActive == 6 }">
                        <span class="icon"><svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <span>Employees</span> <span class="dropdown-icon"><svg xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 320 512"><!--! Font Awesome Pro 6.3.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                <path
                                    d="M137.4 374.6c12.5 12.5 32.8 12.5 45.3 0l128-128c9.2-9.2 11.9-22.9 6.9-34.9s-16.6-19.8-29.6-19.8L32 192c-12.9 0-24.6 7.8-29.6 19.8s-2.2 25.7 6.9 34.9l128 128z" />
                            </svg></span>
                    ...
                    <ul id="employees">
                        <li>
                            <a href="#" v-on:click="makeActive(7), compToRender = 'AddEmployee'"
                        ...
                        <li>
                            <a href="#" v-on:click="makeActive(8), compToRender = 'ViewEmployees'"
                        ...
                        <li>
                            <a href="#" v-on:click="makeActive(9), compToRender = 'ManageEmployees'"
                ...
                <li>
                    <a href="#" v-on:click="makeActive(13), DropdownTags()" v-bind:class="{ active: isActive == 13 }">
                        <span class="icon"><svg xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 448 512"><!--! Font Awesome Pro 6.3.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                <path
                                    d="M0 80V229.5c0 17 6.7 33.3 18.7 45.3l176 176c25 25 65.5 25 90.5 0L418.7 317.3c25-25 25-65.5 0-90.5l-176-176c-12-12-28.3-18.7-45.3-18.7H48C21.5 32 0 53.5 0 80zm112 32a32 32 0 1 1 0 64 32 32 0 1 1 0-64z" />
                            </svg></span>
                        <span>Specializations</span><span class="dropdown-icon"><svg xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 320 512"><!--! Font Awesome Pro 6.3.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                <path
                                    d="M137.4 374.6c12.5 12.5 32.8 12.5 45.3 0l128-128c9.2-9.2 11.9-22.9 6.9-34.9s-16.6-19.8-29.6-19.8L32 192c-12.9 0-24.6 7.8-29.6 19.8s-2.2 25.7 6.9 34.9l128 128z" />
                            </svg></span>
                    ...
                    <ul id="tags">
                        <li>
                            <a href="#" v-on:click="makeActive(14), compToRender = ''"
                        ...
                        <li>
                            <a href="#" v-on:click="makeActive(15), compToRender = ''"
                ...
                <li>
                    <a href="#" v-on:click="makeActive(16)" v-bind:class="{ active: isActive == 16 }">
                        <span class="icon"><svg xmlns="http://www.w3.org/2000/svg"
                ...
                <li>
                    <a href="#" v-on:click="makeActive(17)" v-bind:class="{ active: isActive == 17 }">
                        <span class="icon"><svg xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 512 512"><!--! Font Awesome Pro 6.3.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                <path
...
export default {
    ...
    methods: {
        ...
        DropdownEmployees() {
            if (document.getElementById("employees").style.display == "block") {
        ...
        DropdownRanks() {
            if (document.getElementById("ranks").style.display == "block") {
        ...
        DropdownTags() {
            if (document.getElementById("tags").style.display == "block") {
...
<style>@import '../styles/components/sidebar.css';</style>